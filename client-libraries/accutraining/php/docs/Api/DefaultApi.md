...
try {
    ...
    echo 'Exception when calling DefaultApi->usertaskdeleteplan: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **token** | **string**| The authentication token. |
 **id** | [**string**](../Model/.md)| The id of the task plan to delete. |
...
try {
    ...
    echo 'Exception when calling DefaultApi->usertaskgetmine: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DefaultApi->usertaskgetplan: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DefaultApi->usertasklistdefs: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DefaultApi->usertasklistplan: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DefaultApi->usertasksaveplan: ', $e->getMessage(), PHP_EOL;
}
?>
```
