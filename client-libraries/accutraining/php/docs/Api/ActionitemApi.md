...
$apiInstance = new OpenAPI\Client\Api\ActionitemApi(
...
try {
    ...
    echo 'Exception when calling ActionitemApi->actionitemDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ActionitemApi->actionitemGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ActionitemApi->actionitemList: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ActionitemApi->actionitemSave: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| The id of the action item to save (leave empty to create a new one). |
