...
export class QrloginApi {
    ...
    public setApiKey(key: QrloginApiApiKeys, value: string) {
        (this.authentications as any)[QrloginApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async qrloginGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/qrlogin/get';
    ...
    public async qrloginLogin (onetimetoken: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/qrlogin/login';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
