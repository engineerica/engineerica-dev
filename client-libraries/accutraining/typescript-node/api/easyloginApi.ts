...
export enum EasyloginApiApiKeys {
}

export class EasyloginApi {
    ...
    public setApiKey(key: EasyloginApiApiKeys, value: string) {
        (this.authentications as any)[EasyloginApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async easyloginAddbgimage (upload: string, filename: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/easylogin/addbgimage';
