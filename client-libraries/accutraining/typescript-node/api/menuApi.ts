...
export class MenuApi {
    ...
    public setApiKey(key: MenuApiApiKeys, value: string) {
        (this.authentications as any)[MenuApiApiKeys[key]].apiKey = value;
    }
    ...
    public async menuGetitems (menuid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/menu/getitems';
