...
export enum AdvrolesApiApiKeys {
}

export class AdvrolesApi {
    ...
    public setApiKey(key: AdvrolesApiApiKeys, value: string) {
        (this.authentications as any)[AdvrolesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async advrolesUserlist (from: number, count: number, roleid?: string, onlywithoutcard?: string, photosize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/advroles/userlist';
