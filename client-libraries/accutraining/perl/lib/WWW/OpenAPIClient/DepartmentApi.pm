...
#
package WWW::OpenAPIClient::DepartmentApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'department_delete' } = { 
...
# @return void
#
sub department_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling department_delete");
    }

    # parse inputs
    my $_resource_path = '/department/{id}';
...
# @param string $id The id of the department to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'department_get' } = { 
...
sub department_get {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling department_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'department_list' } = { 
...
sub department_list {
    ...
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling department_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling department_list");
    }

    # parse inputs
    my $_resource_path = '/department/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'department_save' } = { 
...
sub department_save {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling department_save");
    }
