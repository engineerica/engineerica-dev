...
#
# usertaskdeleteplan test
#
{
    my $token = undef; # replace NULL with a proper value
    my $id = undef; # replace NULL with a proper value
    my $result = $api->usertaskdeleteplan(token => $token, id => $id);
}

#
# usertaskgetmine test
#
{
    my $token = undef; # replace NULL with a proper value
    my $result = $api->usertaskgetmine(token => $token);
}

#
# usertaskgetplan test
#
{
    my $token = undef; # replace NULL with a proper value
    my $id = undef; # replace NULL with a proper value
    my $result = $api->usertaskgetplan(token => $token, id => $id);
}

#
# usertasklistdefs test
#
{
    my $result = $api->usertasklistdefs();
}

#
# usertasklistplan test
#
{
    my $token = undef; # replace NULL with a proper value
    my $from = undef; # replace NULL with a proper value
    my $count = undef; # replace NULL with a proper value
    my $result = $api->usertasklistplan(token => $token, from => $from, count => $count);
}

#
# usertasksaveplan test
#
{
    my $unknown_base_type = undef; # replace NULL with a proper value
    my $result = $api->usertasksaveplan(unknown_base_type => $unknown_base_type);
}
