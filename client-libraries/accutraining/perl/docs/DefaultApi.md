...
# **usertaskdeleteplan**
> usertaskdeleteplan(token => $token, id => $id)
...
my $token = "token_example"; # string | The authentication token.
my $id = null; # string | The id of the task plan to delete.

eval { 
    $api_instance->usertaskdeleteplan(token => $token, id => $id);
};
if ($@) {
    warn "Exception when calling DefaultApi->usertaskdeleteplan: $@\n";
}
```
...
eval { 
    $api_instance->usertaskgetmine(token => $token);
};
if ($@) {
    warn "Exception when calling DefaultApi->usertaskgetmine: $@\n";
}
```
...
# **usertaskgetplan**
> usertaskgetplan(token => $token, id => $id)
...
eval { 
    $api_instance->usertaskgetplan(token => $token, id => $id);
};
if ($@) {
    warn "Exception when calling DefaultApi->usertaskgetplan: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling DefaultApi->usertasklistdefs: $@\n";
}
```
...
# **usertasklistplan**
> usertasklistplan(token => $token, from => $from, count => $count)
...
eval { 
    $api_instance->usertasklistplan(token => $token, from => $from, count => $count);
};
if ($@) {
    warn "Exception when calling DefaultApi->usertasklistplan: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling DefaultApi->usertasksaveplan: $@\n";
}
```
