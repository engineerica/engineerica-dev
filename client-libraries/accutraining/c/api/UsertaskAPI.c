...
UsertaskAPI_usertaskDeleteplan(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/deleteplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/deleteplan");
...
UsertaskAPI_usertaskGetmine(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/getmine")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/getmine");
...
UsertaskAPI_usertaskGetplan(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/getplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/getplan");
...
UsertaskAPI_usertaskListdefs(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/listdefs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/listdefs");
...
UsertaskAPI_usertaskListplan(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/listplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/listplan");
...
UsertaskAPI_usertaskSaveplan(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/usertask/saveplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertask/saveplan");
