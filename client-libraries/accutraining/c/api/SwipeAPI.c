...
SwipeAPI_swipeDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/swipe/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/swipe/{id}");
...
SwipeAPI_swipeList(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/swipe/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/swipe/list");
...
SwipeAPI_swipeSave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/swipe/save")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/swipe/save");
...
SwipeAPI_swipeSaveanonym(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/swipe/saveanonym")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/swipe/saveanonym");
