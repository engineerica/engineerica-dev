...
DefaultAPI_actionassignmentdelete(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentdelete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentdelete");
...
DefaultAPI_actionassignmentget(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentget")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentget");
...
DefaultAPI_actionassignmentlist(apiClient_t *apiClient, char * token , int from , int count , int assignee , int status )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentlist")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentlist");
...
DefaultAPI_actionassignmentlisthistory(apiClient_t *apiClient, char * token , char * actionassignment )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentlisthistory")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentlisthistory");
...
DefaultAPI_actionassignmentlistmine(apiClient_t *apiClient, char * token , int from , int count , int status )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentlistmine")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentlistmine");
...
DefaultAPI_actionassignmentlistpublichistory(apiClient_t *apiClient, char * token , char * actionassignment )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentlistpublichistory")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentlistpublichistory");
...
DefaultAPI_actionassignmentmarkcomplete(apiClient_t *apiClient, char * token , char * item , char * assignee , char * group , char * notes )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentmarkcomplete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentmarkcomplete");
...
DefaultAPI_actionassignmentsave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentsave")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentsave");
...
DefaultAPI_actionassignmentsavehistory(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionassignmentsavehistory")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionassignmentsavehistory");
...
DefaultAPI_actionitemdelete(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionitemdelete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionitemdelete");
...
DefaultAPI_actionitemget(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionitemget")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionitemget");
...
DefaultAPI_actionitemlist(apiClient_t *apiClient, char * token , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionitemlist")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionitemlist");
...
DefaultAPI_actionitemsave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionitemsave")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionitemsave");
...
DefaultAPI_actionpackassign(apiClient_t *apiClient, char * token , char * pack , int itemsdata , char * assignee , char * group , char * notes )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionpackassign")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionpackassign");
...
DefaultAPI_actionpackdelete(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionpackdelete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionpackdelete");
...
DefaultAPI_actionpackget(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionpackget")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionpackget");
...
DefaultAPI_actionpacklist(apiClient_t *apiClient, char * token , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionpacklist")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionpacklist");
...
DefaultAPI_actionpacksave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actionpacksave")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actionpacksave");
...
DefaultAPI_actiontypedelete(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actiontypedelete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actiontypedelete");
...
DefaultAPI_actiontypeget(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actiontypeget")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actiontypeget");
...
DefaultAPI_actiontypelist(apiClient_t *apiClient, char * token , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actiontypelist")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actiontypelist");
...
DefaultAPI_actiontypesave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/actiontypesave")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/actiontypesave");
...
DefaultAPI_departmentdelete(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/departmentdelete")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/departmentdelete");
...
DefaultAPI_departmentget(apiClient_t *apiClient, char * token , char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/departmentget")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/departmentget");
...
DefaultAPI_departmentlist(apiClient_t *apiClient, char * token , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/departmentlist")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/departmentlist");
...
DefaultAPI_departmentsave(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/departmentsave")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/departmentsave");
...
//
void
DefaultAPI_usertaskdeleteplan(apiClient_t *apiClient, char * token , char * id )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertaskdeleteplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertaskdeleteplan");
...
//
void
DefaultAPI_usertaskgetmine(apiClient_t *apiClient, char * token )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertaskgetmine")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertaskgetmine");
...
//
void
DefaultAPI_usertaskgetplan(apiClient_t *apiClient, char * token , char * id )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertaskgetplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertaskgetplan");
...
//
void
DefaultAPI_usertasklistdefs(apiClient_t *apiClient)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertasklistdefs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertasklistdefs");
...
//
void
DefaultAPI_usertasklistplan(apiClient_t *apiClient, char * token , int from , int count )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertasklistplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertasklistplan");
...
//
void
DefaultAPI_usertasksaveplan(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/usertasksaveplan")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/usertasksaveplan");
