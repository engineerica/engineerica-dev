...
class LicenseApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun licenseAcceptagreement() : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun licenseGetagreementstatus() : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun licenseRenew(email: kotlin.String, phonenumber: kotlin.String, jobtitle: kotlin.String?, institution: kotlin.String?, comments: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
