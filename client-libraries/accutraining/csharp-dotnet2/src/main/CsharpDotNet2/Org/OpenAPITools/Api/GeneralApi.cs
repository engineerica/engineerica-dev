...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IGeneralApi
    {
        ...
        /// <summary>
        /// Export AccuTraining data Allows the user to export data from AccuTraining into a CSV, HTML, or Excel format.
        /// </summary>
        ...
        /// <summary>
        /// Import data into AccuTraining Allows the user to import data into AccuTraining via CSV or flat files either manually or automatically using the import utility.
        /// </summary>
