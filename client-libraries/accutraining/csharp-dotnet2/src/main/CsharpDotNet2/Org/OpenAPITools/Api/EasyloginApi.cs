...
namespace Org.OpenAPITools.Api
{
    ...
    {
        /// <summary>
        /// Adds background image for the login Allows the user to set the background image that all users will see when logging into an AccuTraining account not using SSO.
        /// </summary>
