...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ILicenseApi
    {
        ...
        /// <summary>
        /// Contact Engineerica in order to renew the AccuTraining subscription Allows the user to select the option to contact Engineerica when the AccuTraining account is nearing its renewal date.
        /// </summary>
