...
namespace Example
{
    public class UsertaskdeleteplanExample
    {
        public void main()
        {
            var apiInstance = new DefaultApi();
            var token = token_example;  // string | The authentication token.
            var id = new Guid?(); // Guid? | The id of the task plan to delete.
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertaskdeleteplan: " + e.Message );
            }
        }
    }
}
...
------------- | ------------- | ------------- | -------------
 **token** | **string**| The authentication token. | 
 **id** | [**Guid?**](.md)| The id of the task plan to delete. | 
...
namespace Example
{
    public class UsertaskgetmineExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertaskgetmine: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UsertaskgetplanExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertaskgetplan: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UsertasklistdefsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertasklistdefs: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UsertasklistplanExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertasklistplan: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UsertasksaveplanExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.Usertasksaveplan: " + e.Message );
            }
        }
    }
}
