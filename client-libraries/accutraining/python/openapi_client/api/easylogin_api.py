...
class EasyloginApi(object):
    ...
    def easylogin_addbgimage(self, upload, filename, **kwargs):  # noqa: E501
        """Adds background image for the login  # noqa: E501

        Allows the user to set the background image that all users will see when logging into an AccuTraining account not using SSO.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.easylogin_addbgimage(upload, filename, async_req=True)
        >>> result = thread.get()
        ...
        return self.easylogin_addbgimage_with_http_info(upload, filename, **kwargs)  # noqa: E501

    def easylogin_addbgimage_with_http_info(self, upload, filename, **kwargs):  # noqa: E501
        """Adds background image for the login  # noqa: E501

        Allows the user to set the background image that all users will see when logging into an AccuTraining account not using SSO.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.easylogin_addbgimage_with_http_info(upload, filename, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method easylogin_addbgimage" % key
                )
        ...
        if self.api_client.client_side_validation and ('upload' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `upload` when calling `easylogin_addbgimage`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filename' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `filename` when calling `easylogin_addbgimage`")  # noqa: E501
