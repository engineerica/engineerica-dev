...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.MyApi(api_client)
    
    try:
        # Gets the logged in user account.
        api_instance.my_account()
    except ApiException as e:
        print("Exception when calling MyApi->my_account: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MyApi->my_ianatimezone: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MyApi->my_profile: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MyApi->my_rights: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MyApi->my_saveprofile: %s\n" % e)
```
