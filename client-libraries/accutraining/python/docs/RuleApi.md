...
body = None # object |  (optional)
    ...
    try:
        # Delete a rule
        api_instance.rule_delete(id, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RuleApi->rule_geteventtype: %s\n" % e)
```
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of user rules
        api_instance.rule_list(_from, count)
    except ApiException as e:
        print("Exception when calling RuleApi->rule_list: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RuleApi->rule_listactions: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RuleApi->rule_listeventtypes: %s\n" % e)
```
...
> rule_listhttprequests(_from, count, failed=failed, status=status)
...
status = 56 # int | The http status to filter the requests (optional)
    ...
    try:
        # View all the http requests sent as a result of a rule
        api_instance.rule_listhttprequests(_from, count, failed=failed, status=status)
    except ApiException as e:
        print("Exception when calling RuleApi->rule_listhttprequests: %s\n" % e)
```
...
# **rule_save**
> rule_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RuleApi(api_client)
    id = 'id_example' # str | The id of the rule to save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit a rule
        api_instance.rule_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling RuleApi->rule_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the rule to save (leave empty to create a new one). | 
