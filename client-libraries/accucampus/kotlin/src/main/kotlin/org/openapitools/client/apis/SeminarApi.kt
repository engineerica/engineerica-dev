...
class SeminarApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun seminarDelete(id: java.util.UUID, body: AnyType?) : Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/seminar/{id}".replace("{"+"id"+"}", "$id"),
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun seminarGet(id: java.util.UUID) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun seminarList(from: kotlin.String, count: kotlin.String, summaryonly: kotlin.Boolean?, termid: java.util.UUID?) : Unit {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun seminarSave(id: java.util.UUID, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE?) : Unit {
