...
class ReportApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun reportAttanalyticsprepare(reportname: kotlin.String, params: kotlin.String?, refreshgroup: java.util.UUID?) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun reportTagresults(reportname: kotlin.String, assign: kotlin.Boolean, tags: kotlin.String, params: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                put("reportname", listOf(reportname.toString()))
