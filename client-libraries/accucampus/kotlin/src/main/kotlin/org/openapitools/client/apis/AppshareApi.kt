...
class AppshareApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun appshareSendtext(phonenumber: kotlin.String?) : Unit {
        val localVariableBody: kotlin.Any? = null
