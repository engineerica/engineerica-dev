...
export enum VirtuallineApiApiKeys {
}

export class VirtuallineApi {
    ...
    public setApiKey(key: VirtuallineApiApiKeys, value: string) {
        (this.authentications as any)[VirtuallineApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async virtuallineAddmyself (waitinglineid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/virtualline/addmyself';
     ...
     */
    public async virtuallineList (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/virtualline/list';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
     ...
     */
    public async virtuallineRemovemyself (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/virtualline/removemyself';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
