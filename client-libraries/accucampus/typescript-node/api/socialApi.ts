...
export class SocialApi {
     ...
     */
    public async socialContacts (filter?: string, showdefaultphoto?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/social/contacts';
