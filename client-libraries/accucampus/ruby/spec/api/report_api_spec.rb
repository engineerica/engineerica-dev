...
describe 'ReportApi' do
  ...
  # unit tests for report_attanalyticsprepare
  ...
  # @return [nil]
  describe 'report_attanalyticsprepare test' do
    it 'should work' do
  ...
  # unit tests for report_tagresults
  ...
  # @option opts [String] :params A pipe separated list of the parameters. Example: key1&#x3D;value1|key2&#x3D;value2|key3&#x3D;value3
  # @return [nil]
  describe 'report_tagresults test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
