...
describe 'StationApi' do
  ...
  # unit tests for station_getlocationsettings
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'station_getlocationsettings test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for station_savemine
  ...
  # @option opts [UNKNOWN_BASE_TYPE] :unknown_base_type 
  # @return [nil]
  describe 'station_savemine test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
