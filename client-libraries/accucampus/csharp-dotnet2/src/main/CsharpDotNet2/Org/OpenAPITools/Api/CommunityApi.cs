...
namespace Org.OpenAPITools.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class CommunityApi : ICommunityApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunityApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public CommunityApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public CommunityApi(String basePath)
        {
        ...
        /// </summary>
        /// <returns></returns>            
        public void CommunityInvite ()
        {
            
    
            var path = "/community/invite";
        ...
        /// </summary>
        /// <returns></returns>            
        public void CommunityJoin ()
        {
            
    
            var path = "/community/join";
            path = path.Replace("{format}", "json");
