...
class UsergroupApi(object):
    ...
    def usergroup_tagmembers(self, group, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usergroup_tagmembers(group, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usergroup_tagmembers_with_http_info(group, **kwargs)  # noqa: E501

    def usergroup_tagmembers_with_http_info(self, group, **kwargs):  # noqa: E501
        """Assign tags to the members of a specified group  # noqa: E501

        Allows the user to assign tags to the users of a group that they have permission to edit.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usergroup_tagmembers_with_http_info(group, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usergroup_tagmembers" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'group' is set
        if self.api_client.client_side_validation and ('group' not in local_var_params or  # noqa: E501
                                                        local_var_params['group'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `group` when calling `usergroup_tagmembers`")  # noqa: E501
    ...
    def usergroup_untagmembers(self, group, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usergroup_untagmembers(group, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usergroup_untagmembers_with_http_info(group, **kwargs)  # noqa: E501

    def usergroup_untagmembers_with_http_info(self, group, **kwargs):  # noqa: E501
        """Unassign tags from the members of a specified group  # noqa: E501

        Allows the user to unassign tags to the users of a group that they have permission to edit.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usergroup_untagmembers_with_http_info(group, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usergroup_untagmembers" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'group' is set
        if self.api_client.client_side_validation and ('group' not in local_var_params or  # noqa: E501
                                                        local_var_params['group'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `group` when calling `usergroup_untagmembers`")  # noqa: E501
