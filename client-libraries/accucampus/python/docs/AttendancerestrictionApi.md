# openapi_client.AttendancerestrictionApi
...
> attendancerestriction_delete(id, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AttendancerestrictionApi(api_client)
    id = 'id_example' # str | The id of the restriction to delete.
body = None # object |  (optional)

    try:
        # Delete an attendance restriction
        api_instance.attendancerestriction_delete(id, body=body)
    except ApiException as e:
        print("Exception when calling AttendancerestrictionApi->attendancerestriction_delete: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the restriction to delete. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.AttendancerestrictionApi(api_client)
    id = 'id_example' # str | The id of the restriction to get.

    try:
        # View details of an attendance restriction
        api_instance.attendancerestriction_get(id)
    except ApiException as e:
        print("Exception when calling AttendancerestrictionApi->attendancerestriction_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the restriction to get. | 
...
> attendancerestriction_list(_from, count)
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of attendance restrictions
        api_instance.attendancerestriction_list(_from, count)
    except ApiException as e:
        print("Exception when calling AttendancerestrictionApi->attendancerestriction_list: %s\n" % e)
```
...
> attendancerestriction_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.AttendancerestrictionApi(api_client)
    id = 'id_example' # str | The id of the restriction save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit an attendance restriction
        api_instance.attendancerestriction_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling AttendancerestrictionApi->attendancerestriction_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the restriction save (leave empty to create a new one). | 
