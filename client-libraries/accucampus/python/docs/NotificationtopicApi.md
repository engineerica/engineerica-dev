# openapi_client.NotificationtopicApi
...
> notificationtopic_delete(id, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.NotificationtopicApi(api_client)
    id = 'id_example' # str | The id of the notification topic to delete.
body = None # object |  (optional)

    try:
        # Delete a notification topic
        api_instance.notificationtopic_delete(id, body=body)
    except ApiException as e:
        print("Exception when calling NotificationtopicApi->notificationtopic_delete: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotificationtopicApi->notificationtopic_get: %s\n" % e)
```
...
> notificationtopic_list(_from, count)
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # List all the notification topics
        api_instance.notificationtopic_list(_from, count)
    except ApiException as e:
        print("Exception when calling NotificationtopicApi->notificationtopic_list: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NotificationtopicApi->notificationtopic_listsubscribe: %s\n" % e)
```
...
> notificationtopic_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.NotificationtopicApi(api_client)
    id = 'id_example' # str | The id of the topic to save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit a notification topic
        api_instance.notificationtopic_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling NotificationtopicApi->notificationtopic_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the topic to save (leave empty to create a new one). | 
