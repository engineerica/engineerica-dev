...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | The id of the service to delete.
body = None # object |  (optional)

    try:
        # Delete a service
        api_instance.service_delete(id, body=body)
...
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the service to delete. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ServiceApi(api_client)
    id = 'id_example' # str | The id of the service to get.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the service to get. | 
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of services
        api_instance.service_list(_from, count)
    except ApiException as e:
...
# **service_save**
> service_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ServiceApi(api_client)
    id = 'id_example' # str | The id of the service save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit a service
        api_instance.service_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling ServiceApi->service_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the service save (leave empty to create a new one). | 
