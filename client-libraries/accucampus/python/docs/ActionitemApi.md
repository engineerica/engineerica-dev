...
# **actionitem_delete**
> actionitem_delete(id, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ActionitemApi(api_client)
    id = 'id_example' # str | The id of the action item to delete.
body = None # object |  (optional)

    try:
        # Delete an action item
        api_instance.actionitem_delete(id, body=body)
    except ApiException as e:
        print("Exception when calling ActionitemApi->actionitem_delete: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ActionitemApi->actionitem_get: %s\n" % e)
```
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of action items
        api_instance.actionitem_list(_from, count)
    except ApiException as e:
        print("Exception when calling ActionitemApi->actionitem_list: %s\n" % e)
```
...
# **actionitem_save**
> actionitem_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ActionitemApi(api_client)
    id = 'id_example' # str | The id of the action item to save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit an action item
        api_instance.actionitem_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling ActionitemApi->actionitem_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the action item to save (leave empty to create a new one). | 
