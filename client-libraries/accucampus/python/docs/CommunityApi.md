...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CommunityApi(api_client)
    
    try:
        # Sends an invitation to everyone to AccuCampus Communities
        api_instance.community_invite()
    except ApiException as e:
        print("Exception when calling CommunityApi->community_invite: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CommunityApi->community_join: %s\n" % e)
```
