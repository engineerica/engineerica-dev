...
# **actiontype_delete**
> actiontype_delete(id, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ActiontypeApi(api_client)
    id = 'id_example' # str | The id of the action type to delete.
body = None # object |  (optional)

    try:
        # Delete an action item type
        api_instance.actiontype_delete(id, body=body)
    except ApiException as e:
        print("Exception when calling ActiontypeApi->actiontype_delete: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ActiontypeApi->actiontype_get: %s\n" % e)
```
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of action item types
        api_instance.actiontype_list(_from, count)
    except ApiException as e:
        print("Exception when calling ActiontypeApi->actiontype_list: %s\n" % e)
```
...
# **actiontype_save**
> actiontype_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ActiontypeApi(api_client)
    id = 'id_example' # str | The id of the action type to save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit an action item type
        api_instance.actiontype_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling ActiontypeApi->actiontype_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the action type to save (leave empty to create a new one). | 
