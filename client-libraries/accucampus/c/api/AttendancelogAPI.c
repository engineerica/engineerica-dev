...
//
void
AttendancelogAPI_attendancelogListstaff(apiClient_t *apiClient, int from , int count , char * filter )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/attendancelog/liststaff")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/attendancelog/liststaff");
