...
CommunityAPI_communityInvite(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/community/invite")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/community/invite");
...
CommunityAPI_communityJoin(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/community/join")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/community/join");
