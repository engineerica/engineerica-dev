...
RiskmodelAPI_riskmodelCheckanalysis(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/checkanalysis")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/checkanalysis");
...
RiskmodelAPI_riskmodelDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/{id}");
...
RiskmodelAPI_riskmodelGetscore(apiClient_t *apiClient, char * userid )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/getscore")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/getscore");
...
RiskmodelAPI_riskmodelList(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/list");
...
RiskmodelAPI_riskmodelPredict(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/predict")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/predict");
...
RiskmodelAPI_riskmodelProcess(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/process")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/process");
...
RiskmodelAPI_riskmodelRefresh(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/refresh")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/refresh");
...
RiskmodelAPI_riskmodelTermprecedences(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/riskmodel/termprecedences")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/riskmodel/termprecedences");
