...
CompasscategoryAPI_compasscategoryDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/compasscategory/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/compasscategory/{id}");
...
CompasscategoryAPI_compasscategoryList(apiClient_t *apiClient, int from , int count , int onlywithservices )
{
    ...
    // create the path
    long sizeOfPath = strlen("/compasscategory/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/compasscategory/list");
    ...
    // query parameters
    char *keyQuery_onlywithservices = NULL;
    int valueQuery_onlywithservices ;
    keyValuePair_t *keyPairQuery_onlywithservices = 0;
    if (onlywithservices)
    {
        keyQuery_onlywithservices = strdup("onlywithservices");
        valueQuery_onlywithservices = (onlywithservices);
        keyPairQuery_onlywithservices = keyValuePair_create(keyQuery_onlywithservices, &valueQuery_onlywithservices);
        list_addElement(localVarQueryParameters,keyPairQuery_onlywithservices);
    }
    apiClient_invoke(apiClient,
                    localVarPath,
                    localVarQueryParameters,
