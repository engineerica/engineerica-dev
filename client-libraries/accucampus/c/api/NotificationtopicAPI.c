...
#include <stdio.h>
#include <ctype.h>
#include "NotificationtopicAPI.h"
...
NotificationtopicAPI_notificationtopicDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/notificationtopic/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/notificationtopic/{id}");
...
NotificationtopicAPI_notificationtopicList(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/notificationtopic/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/notificationtopic/list");
...
NotificationtopicAPI_notificationtopicListsubscribe(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/notificationtopic/listsubscribe")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/notificationtopic/listsubscribe");
