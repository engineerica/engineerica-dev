...
BeaconAPI_beaconDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/{id}");
...
BeaconAPI_beaconDisable(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/disable")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/disable");
...
BeaconAPI_beaconGetlocations(apiClient_t *apiClient, char * beacons )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/getlocations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/getlocations");




    // query parameters
    char *keyQuery_beacons = NULL;
    char * valueQuery_beacons = NULL;
    keyValuePair_t *keyPairQuery_beacons = 0;
    if (beacons)
    {
        keyQuery_beacons = strdup("beacons");
        valueQuery_beacons = strdup((beacons));
        keyPairQuery_beacons = keyValuePair_create(keyQuery_beacons, valueQuery_beacons);
        list_addElement(localVarQueryParameters,keyPairQuery_beacons);
    }
    apiClient_invoke(apiClient,
                    localVarPath,
                    localVarQueryParameters,
    ...
    free(localVarPath);
    if(keyQuery_beacons){
        free(keyQuery_beacons);
        keyQuery_beacons = NULL;
    }
    if(valueQuery_beacons){
        free(valueQuery_beacons);
        valueQuery_beacons = NULL;
    }
    if(keyPairQuery_beacons){
        keyValuePair_free(keyPairQuery_beacons);
        keyPairQuery_beacons = NULL;
    }
    if(keyQuery_beacons){
        free(keyQuery_beacons);
        keyQuery_beacons = NULL;
...
BeaconAPI_beaconGetstationlocation(apiClient_t *apiClient, char * station , char * location )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/getstationlocation")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/getstationlocation");
...
BeaconAPI_beaconGetuuid(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/getuuid")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/getuuid");
...
BeaconAPI_beaconList(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/list");
...
BeaconAPI_beaconListprofiles(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/listprofiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/listprofiles");
...
BeaconAPI_beaconResetuuid(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/resetuuid")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/resetuuid");
...
BeaconAPI_beaconScanlocations(apiClient_t *apiClient, char * beacons )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/scanlocations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/scanlocations");
...
BeaconAPI_beaconSetuuid(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/setuuid")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/setuuid");
...
BeaconAPI_beaconSilentregions(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/silentregions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/silentregions");
...
BeaconAPI_beaconSilentsignin(apiClient_t *apiClient, char * uuid )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/silentsignin")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/silentsignin");




    // query parameters
    char *keyQuery_uuid = NULL;
    char * valueQuery_uuid ;
    keyValuePair_t *keyPairQuery_uuid = 0;
    if (uuid)
    {
        keyQuery_uuid = strdup("uuid");
        valueQuery_uuid = (uuid);
        keyPairQuery_uuid = keyValuePair_create(keyQuery_uuid, &valueQuery_uuid);
        list_addElement(localVarQueryParameters,keyPairQuery_uuid);
    }
    apiClient_invoke(apiClient,
                    localVarPath,
                    localVarQueryParameters,
...
BeaconAPI_beaconSilentsignout(apiClient_t *apiClient, char * uuid )
{
    ...
    // create the path
    long sizeOfPath = strlen("/beacon/silentsignout")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/beacon/silentsignout");
