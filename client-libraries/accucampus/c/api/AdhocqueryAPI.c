...
AdhocqueryAPI_adhocqueryCheckexecution(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/checkexecution")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/checkexecution");
...
AdhocqueryAPI_adhocqueryDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/{id}");
...
AdhocqueryAPI_adhocqueryExecute(apiClient_t *apiClient, char * id , char * query )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/execute")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/execute");
...
AdhocqueryAPI_adhocqueryGetschema(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/getschema")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/getschema");
...
AdhocqueryAPI_adhocqueryList(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/list");
...
AdhocqueryAPI_adhocqueryListexecutions(apiClient_t *apiClient, int from , int count , char * query )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/listexecutions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/listexecutions");
...
AdhocqueryAPI_adhocqueryStopexecution(apiClient_t *apiClient, char * id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/adhocquery/stopexecution")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/adhocquery/stopexecution");
