...
ReportAPI_reportAttanalyticsprepare(apiClient_t *apiClient, char * reportname , char * params , char * refreshgroup )
{
    ...
    // create the path
    long sizeOfPath = strlen("/report/attanalyticsprepare")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/report/attanalyticsprepare");
...
ReportAPI_reportTagresults(apiClient_t *apiClient, char * reportname , int assign , char * tags , char * params )
{
    ...
    // create the path
    long sizeOfPath = strlen("/report/tagresults")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/report/tagresults");
