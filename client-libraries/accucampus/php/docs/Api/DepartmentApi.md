...
try {
    ...
    echo 'Exception when calling DepartmentApi->departmentList: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DepartmentApi->departmentSave: ', $e->getMessage(), PHP_EOL;
}
?>
```
