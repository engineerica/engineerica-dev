# OpenAPI\Client\ReportscheduleApi
...
$apiInstance = new OpenAPI\Client\Api\ReportscheduleApi(
...
try {
    ...
    echo 'Exception when calling ReportscheduleApi->reportscheduleDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ReportscheduleApi->reportscheduleGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ReportscheduleApi->reportscheduleList: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ReportscheduleApi->reportscheduleSave: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| The id of the schedule save (leave empty to create a new one). |
