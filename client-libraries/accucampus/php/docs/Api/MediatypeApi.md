...
$apiInstance = new OpenAPI\Client\Api\MediatypeApi(
...
try {
    ...
    echo 'Exception when calling MediatypeApi->mediatypeDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MediatypeApi->mediatypeGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MediatypeApi->mediatypeList: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MediatypeApi->mediatypeSave: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| The id of the mediaType save (leave empty to create a new one). |
