...
/**
 * EasyloginApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class EasyloginApi
{
     ...
     * @return void
     */
    public function easyloginAddbgimage($upload, $filename)
    {
        $this->easyloginAddbgimageWithHttpInfo($upload, $filename);
    }
     ...
     */
    public function easyloginAddbgimageWithHttpInfo($upload, $filename)
    {
        $request = $this->easyloginAddbgimageRequest($upload, $filename);
     ...
     */
    public function easyloginAddbgimageAsync($upload, $filename)
    {
        return $this->easyloginAddbgimageAsyncWithHttpInfo($upload, $filename)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function easyloginAddbgimageAsyncWithHttpInfo($upload, $filename)
    {
        $returnType = '';
        $request = $this->easyloginAddbgimageRequest($upload, $filename);
     ...
     */
    protected function easyloginAddbgimageRequest($upload, $filename)
    {
        ...
        $resourcePath = '/easylogin/addbgimage';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
