...
class ReportApi
{
    ...
    /**
     * Operation reportAttanalyticsprepare
     *
     ...
     * @return void
     */
    public function reportAttanalyticsprepare($reportname, $params = null, $refreshgroup = null)
    {
        $this->reportAttanalyticsprepareWithHttpInfo($reportname, $params, $refreshgroup);
    }

    /**
     * Operation reportAttanalyticsprepareWithHttpInfo
     *
     * Query and load an attendance analytics report
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     */
    public function reportAttanalyticsprepareWithHttpInfo($reportname, $params = null, $refreshgroup = null)
    {
        $request = $this->reportAttanalyticsprepareRequest($reportname, $params, $refreshgroup);
    ...
    /**
     * Operation reportAttanalyticsprepareAsync
     *
     * Query and load an attendance analytics report
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     */
    public function reportAttanalyticsprepareAsync($reportname, $params = null, $refreshgroup = null)
    {
        return $this->reportAttanalyticsprepareAsyncWithHttpInfo($reportname, $params, $refreshgroup)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportAttanalyticsprepareAsyncWithHttpInfo
     *
     * Query and load an attendance analytics report
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportAttanalyticsprepareAsyncWithHttpInfo($reportname, $params = null, $refreshgroup = null)
    {
        $returnType = '';
        $request = $this->reportAttanalyticsprepareRequest($reportname, $params, $refreshgroup);
    ...
    /**
     * Create request for operation 'reportAttanalyticsprepare'
     *
     * @param  string $reportname The name of the report to execute (required)
     * @param  string $params A pipe separated list of the parameters. Example: key1&#x3D;value1|key2&#x3D;value2|key3&#x3D;value3 (optional)
     * @param  string $refreshgroup The ID of the group to check (and refresh) before processing the report. (optional)
     ...
     */
    protected function reportAttanalyticsprepareRequest($reportname, $params = null, $refreshgroup = null)
    {
        // verify the required parameter 'reportname' is set
        if ($reportname === null || (is_array($reportname) && count($reportname) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reportname when calling reportAttanalyticsprepare'
            );
        }

        $resourcePath = '/report/attanalyticsprepare';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function reportTagresults($reportname, $assign, $tags, $params = null)
    {
        $this->reportTagresultsWithHttpInfo($reportname, $assign, $tags, $params);
    }

    /**
     * Operation reportTagresultsWithHttpInfo
     *
     * Queries and loads a report in background and assigns (or unassigns) the specified tags to (from) the resulting users.
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportTagresultsWithHttpInfo($reportname, $assign, $tags, $params = null)
    {
        $request = $this->reportTagresultsRequest($reportname, $assign, $tags, $params);
    ...
    /**
     * Operation reportTagresultsAsync
     *
     * Queries and loads a report in background and assigns (or unassigns) the specified tags to (from) the resulting users.
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportTagresultsAsync($reportname, $assign, $tags, $params = null)
    {
        return $this->reportTagresultsAsyncWithHttpInfo($reportname, $assign, $tags, $params)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportTagresultsAsyncWithHttpInfo
     *
     * Queries and loads a report in background and assigns (or unassigns) the specified tags to (from) the resulting users.
     *
     * @param  string $reportname The name of the report to execute (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportTagresultsAsyncWithHttpInfo($reportname, $assign, $tags, $params = null)
    {
        $returnType = '';
        $request = $this->reportTagresultsRequest($reportname, $assign, $tags, $params);
    ...
    /**
     * Create request for operation 'reportTagresults'
     *
     * @param  string $reportname The name of the report to execute (required)
     * @param  bool $assign Specify whether the specified tags have to be assigned or unassigned. (required)
     * @param  string $tags The tags to assign (or unassign) to the resulting users in the report, in JSON format. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function reportTagresultsRequest($reportname, $assign, $tags, $params = null)
    {
        // verify the required parameter 'reportname' is set
        if ($reportname === null || (is_array($reportname) && count($reportname) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reportname when calling reportTagresults'
            );
        }
        // verify the required parameter 'assign' is set
        if ($assign === null || (is_array($assign) && count($assign) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $assign when calling reportTagresults'
            );
        }
        // verify the required parameter 'tags' is set
        if ($tags === null || (is_array($tags) && count($tags) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tags when calling reportTagresults'
            );
        }

        $resourcePath = '/report/tagresults';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
