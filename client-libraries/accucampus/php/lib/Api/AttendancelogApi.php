...
class AttendancelogApi
{
    ...
    /**
     * Operation attendancelogListstaff
     *
     ...
     * @return void
     */
    public function attendancelogListstaff($from, $count, $filter = null)
    {
        $this->attendancelogListstaffWithHttpInfo($from, $count, $filter);
    }

    /**
     * Operation attendancelogListstaffWithHttpInfo
     *
     * Gets the attendance logs that the current user is involved in as staff
     *
     * @param  int $from The first record to return. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function attendancelogListstaffWithHttpInfo($from, $count, $filter = null)
    {
        $request = $this->attendancelogListstaffRequest($from, $count, $filter);
    ...
    /**
     * Operation attendancelogListstaffAsync
     *
     * Gets the attendance logs that the current user is involved in as staff
     *
     * @param  int $from The first record to return. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendancelogListstaffAsync($from, $count, $filter = null)
    {
        return $this->attendancelogListstaffAsyncWithHttpInfo($from, $count, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation attendancelogListstaffAsyncWithHttpInfo
     *
     * Gets the attendance logs that the current user is involved in as staff
     *
     * @param  int $from The first record to return. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attendancelogListstaffAsyncWithHttpInfo($from, $count, $filter = null)
    {
        $returnType = '';
        $request = $this->attendancelogListstaffRequest($from, $count, $filter);
    ...
    /**
     * Create request for operation 'attendancelogListstaff'
     *
     * @param  int $from The first record to return. (required)
     * @param  int $count The max number of records to return. (required)
     * @param  string $filter Filter the logs, valid values are: invalid, not-signed-in, not-signed-out, stayed-less-than-required, out-of-event, valid. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function attendancelogListstaffRequest($from, $count, $filter = null)
    {
        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling attendancelogListstaff'
            );
        }
        // verify the required parameter 'count' is set
        if ($count === null || (is_array($count) && count($count) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $count when calling attendancelogListstaff'
            );
        }

        $resourcePath = '/attendancelog/liststaff';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
