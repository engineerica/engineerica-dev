...
class UsersettingsApi
{
     ...
     * @return void
     */
    public function usersettingsGet($keys, $user = null)
    {
        $this->usersettingsGetWithHttpInfo($keys, $user);
    }
     ...
     */
    public function usersettingsGetWithHttpInfo($keys, $user = null)
    {
        $request = $this->usersettingsGetRequest($keys, $user);
     ...
     */
    public function usersettingsGetAsync($keys, $user = null)
    {
        return $this->usersettingsGetAsyncWithHttpInfo($keys, $user)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersettingsGetAsyncWithHttpInfo($keys, $user = null)
    {
        $returnType = '';
        $request = $this->usersettingsGetRequest($keys, $user);
     ...
     */
    protected function usersettingsGetRequest($keys, $user = null)
    {
     ...
     * @return void
     */
    public function usersettingsGetmultiple($keys, $user = null)
    {
        $this->usersettingsGetmultipleWithHttpInfo($keys, $user);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersettingsGetmultipleWithHttpInfo($keys, $user = null)
    {
        $request = $this->usersettingsGetmultipleRequest($keys, $user);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersettingsGetmultipleAsync($keys, $user = null)
    {
        return $this->usersettingsGetmultipleAsyncWithHttpInfo($keys, $user)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersettingsGetmultipleAsyncWithHttpInfo($keys, $user = null)
    {
        $returnType = '';
        $request = $this->usersettingsGetmultipleRequest($keys, $user);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersettingsGetmultipleRequest($keys, $user = null)
    {
        // verify the required parameter 'keys' is set
        if ($keys === null || (is_array($keys) && count($keys) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/usersettings/getmultiple';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function usersettingsSaveRequest($unknown_base_type = null)
    {
        ...
        $resourcePath = '/usersettings/save';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function usersettingsSavemultipleRequest($unknown_base_type = null)
    {
        ...
        $resourcePath = '/usersettings/savemultiple';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
