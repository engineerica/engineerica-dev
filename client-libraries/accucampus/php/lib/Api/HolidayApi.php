...
class HolidayApi
{
     ...
     * @return void
     */
    public function holidayList($term)
    {
        $this->holidayListWithHttpInfo($term);
    }
     ...
     */
    public function holidayListWithHttpInfo($term)
    {
        $request = $this->holidayListRequest($term);
     ...
     */
    public function holidayListAsync($term)
    {
        return $this->holidayListAsyncWithHttpInfo($term)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function holidayListAsyncWithHttpInfo($term)
    {
        $returnType = '';
        $request = $this->holidayListRequest($term);
     ...
     */
    protected function holidayListRequest($term)
    {
     ...
     * @return void
     */
    public function holidaySuggest($term)
    {
        $this->holidaySuggestWithHttpInfo($term);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function holidaySuggestWithHttpInfo($term)
    {
        $request = $this->holidaySuggestRequest($term);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function holidaySuggestAsync($term)
    {
        return $this->holidaySuggestAsyncWithHttpInfo($term)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function holidaySuggestAsyncWithHttpInfo($term)
    {
        $returnType = '';
        $request = $this->holidaySuggestRequest($term);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function holidaySuggestRequest($term)
    {
        // verify the required parameter 'term' is set
        if ($term === null || (is_array($term) && count($term) === 0)) {
            throw new \InvalidArgumentException(
