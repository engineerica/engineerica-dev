# AccuCampusOpenApi3.UsergroupApi
...
let apiInstance = new AccuCampusOpenApi3.UsergroupApi();
...
> usergroupTagmembers(group, opts)
...
apiInstance.usergroupTagmembers(group, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> usergroupUntagmembers(group, opts)
...
apiInstance.usergroupUntagmembers(group, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
