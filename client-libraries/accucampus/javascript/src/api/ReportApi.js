...
export default class ReportApi {
    ...
    */
     ...
     * @callback module:api/ReportApi~reportAttanalyticsprepareCallback
     ...
     * @param {module:api/ReportApi~reportAttanalyticsprepareCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reportAttanalyticsprepare(reportname, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @callback module:api/ReportApi~reportTagresultsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.params A pipe separated list of the parameters. Example: key1=value1|key2=value2|key3=value3
     * @param {module:api/ReportApi~reportTagresultsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reportTagresults(reportname, assign, tags, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'reportname' is set
      if (reportname === undefined || reportname === null) {
