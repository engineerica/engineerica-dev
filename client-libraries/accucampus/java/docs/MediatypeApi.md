...
import org.openapitools.client.api.MediatypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MediatypeApi apiInstance = new MediatypeApi(defaultClient);
    UUID id = new UUID(); // UUID | The id of the media type to delete.
    oas_any_type_not_mapped body = new oas_any_type_not_mapped(); // oas_any_type_not_mapped | 
    try {
      apiInstance.mediatypeDelete(id, body);
    } catch (ApiException e) {
      System.err.println("Exception when calling MediatypeApi#mediatypeDelete");
...
------------- | ------------- | ------------- | -------------
 **id** | [**UUID**](.md)| The id of the media type to delete. |
...
public class Example {
  public static void main(String[] args) {
    ...
    MediatypeApi apiInstance = new MediatypeApi(defaultClient);
    UUID id = new UUID(); // UUID | The id of the media type to get.
    try {
      apiInstance.mediatypeGet(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling MediatypeApi#mediatypeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**UUID**](.md)| The id of the media type to get. |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MediatypeApi#mediatypeList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    MediatypeApi apiInstance = new MediatypeApi(defaultClient);
    UUID id = new UUID(); // UUID | The id of the mediaType save (leave empty to create a new one).
    UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = new UNKNOWN_BASE_TYPE(); // UNKNOWN_BASE_TYPE | 
    try {
      apiInstance.mediatypeSave(id, UNKNOWN_BASE_TYPE);
    } catch (ApiException e) {
      System.err.println("Exception when calling MediatypeApi#mediatypeSave");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**UUID**](.md)| The id of the mediaType save (leave empty to create a new one). |
