...
# @param string $refreshgroup The ID of the group to check (and refresh) before processing the report. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'report_attanalyticsprepare' } = { 
...
# @return void
#
sub report_attanalyticsprepare {
    my ($self, %args) = @_;

    # verify the required parameter 'reportname' is set
    unless (exists $args{'reportname'}) {
      croak("Missing the required parameter 'reportname' when calling report_attanalyticsprepare");
    }

    # parse inputs
    my $_resource_path = '/report/attanalyticsprepare';
...
# @param string $params A pipe separated list of the parameters. Example: key1&#x3D;value1|key2&#x3D;value2|key3&#x3D;value3 (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'report_tagresults' } = { 
...
# @return void
#
sub report_tagresults {
    my ($self, %args) = @_;

    # verify the required parameter 'reportname' is set
    unless (exists $args{'reportname'}) {
      croak("Missing the required parameter 'reportname' when calling report_tagresults");
    }

    # verify the required parameter 'assign' is set
    unless (exists $args{'assign'}) {
      croak("Missing the required parameter 'assign' when calling report_tagresults");
    }

    # verify the required parameter 'tags' is set
    unless (exists $args{'tags'}) {
      croak("Missing the required parameter 'tags' when calling report_tagresults");
    }

    # parse inputs
    my $_resource_path = '/report/tagresults';
