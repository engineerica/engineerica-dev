...
# @param string $tags The tags to assign to the members of the specified group, in JSON format. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'usergroup_tagmembers' } = { 
...
# @return void
#
sub usergroup_tagmembers {
    my ($self, %args) = @_;

    # verify the required parameter 'group' is set
    unless (exists $args{'group'}) {
      croak("Missing the required parameter 'group' when calling usergroup_tagmembers");
    }

    # parse inputs
    my $_resource_path = '/usergroup/tagmembers';
...
# @param string $tags The tags to unassign from the members of the specified group, in JSON format. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'usergroup_untagmembers' } = { 
...
# @return void
#
sub usergroup_untagmembers {
    my ($self, %args) = @_;

    # verify the required parameter 'group' is set
    unless (exists $args{'group'}) {
      croak("Missing the required parameter 'group' when calling usergroup_untagmembers");
    }

    # parse inputs
    my $_resource_path = '/usergroup/untagmembers';
