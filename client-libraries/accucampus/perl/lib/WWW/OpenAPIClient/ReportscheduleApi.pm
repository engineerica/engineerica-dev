...
#
package WWW::OpenAPIClient::ReportscheduleApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'reportschedule_delete' } = { 
...
# @return void
#
sub reportschedule_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling reportschedule_delete");
    }

    # parse inputs
    my $_resource_path = '/reportschedule/{id}';
...
# @param string $id The id of the schedule to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'reportschedule_get' } = { 
...
# @return void
#
sub reportschedule_get {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling reportschedule_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'reportschedule_list' } = { 
...
# @return void
#
sub reportschedule_list {
    my ($self, %args) = @_;

    # verify the required parameter 'from' is set
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling reportschedule_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling reportschedule_list");
    }

    # parse inputs
    my $_resource_path = '/reportschedule/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'reportschedule_save' } = { 
...
# @return void
#
sub reportschedule_save {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling reportschedule_save");
    }
