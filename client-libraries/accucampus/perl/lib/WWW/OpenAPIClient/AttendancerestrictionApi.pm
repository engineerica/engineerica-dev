...
#
package WWW::OpenAPIClient::AttendancerestrictionApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'attendancerestriction_delete' } = { 
...
# @return void
#
sub attendancerestriction_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling attendancerestriction_delete");
    }

    # parse inputs
    my $_resource_path = '/attendancerestriction/{id}';
...
# @param string $id The id of the restriction to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'attendancerestriction_get' } = { 
...
# @return void
#
sub attendancerestriction_get {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling attendancerestriction_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'attendancerestriction_list' } = { 
...
# @return void
#
sub attendancerestriction_list {
    my ($self, %args) = @_;

    # verify the required parameter 'from' is set
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling attendancerestriction_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling attendancerestriction_list");
    }

    # parse inputs
    my $_resource_path = '/attendancerestriction/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'attendancerestriction_save' } = { 
...
# @return void
#
sub attendancerestriction_save {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling attendancerestriction_save");
    }
