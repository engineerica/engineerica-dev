...
#
package WWW::OpenAPIClient::MediatypeApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'mediatype_delete' } = { 
...
# @return void
#
sub mediatype_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling mediatype_delete");
    }

    # parse inputs
    my $_resource_path = '/mediatype/{id}';
...
# @param string $id The id of the media type to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'mediatype_get' } = { 
...
sub mediatype_get {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling mediatype_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'mediatype_list' } = { 
...
sub mediatype_list {
    ...
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling mediatype_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling mediatype_list");
    }

    # parse inputs
    my $_resource_path = '/mediatype/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'mediatype_save' } = { 
...
sub mediatype_save {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling mediatype_save");
    }
