...
#
package WWW::OpenAPIClient::ActionitemApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'actionitem_delete' } = { 
...
# @return void
#
sub actionitem_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling actionitem_delete");
    }

    # parse inputs
    my $_resource_path = '/actionitem/{id}';
...
# @param string $id The id of the action item to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'actionitem_get' } = { 
...
sub actionitem_get {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling actionitem_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'actionitem_list' } = { 
...
sub actionitem_list {
    ...
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling actionitem_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling actionitem_list");
    }

    # parse inputs
    my $_resource_path = '/actionitem/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'actionitem_save' } = { 
...
sub actionitem_save {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling actionitem_save");
    }
