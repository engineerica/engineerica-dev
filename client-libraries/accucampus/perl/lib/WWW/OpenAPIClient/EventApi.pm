...
# @param boolean $autorepair True to automatically fix the invalid sessions. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'event_checksessions' } = { 
...
# @return void
#
sub event_checksessions {
    my ($self, %args) = @_;

    # verify the required parameter 'eventid' is set
    unless (exists $args{'eventid'}) {
      croak("Missing the required parameter 'eventid' when calling event_checksessions");
    }

    # verify the required parameter 'autorepair' is set
    unless (exists $args{'autorepair'}) {
      croak("Missing the required parameter 'autorepair' when calling event_checksessions");
    }

    # parse inputs
    my $_resource_path = '/event/checksessions';
...
# @param string $termid Id of the term to list the events. Null to list all events. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'event_listregistered' } = { 
...
# @return void
#
sub event_listregistered {
    my ($self, %args) = @_;

    # verify the required parameter 'from' is set
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling event_listregistered");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling event_listregistered");
    }

    # parse inputs
    my $_resource_path = '/event/listregistered';
