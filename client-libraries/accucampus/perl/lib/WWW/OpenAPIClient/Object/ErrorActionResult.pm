...
#
package WWW::OpenAPIClient::Object::ErrorActionResult;
...
__PACKAGE__->class_documentation({description => 'Object returned when the action execution failed',
