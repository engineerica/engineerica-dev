...
#
package WWW::OpenAPIClient::CommunityApi;
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'community_invite' } = { 
...
# @return void
#
sub community_invite {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/community/invite';
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'community_join' } = { 
...
sub community_join {
    ...
    # parse inputs
    my $_resource_path = '/community/join';
