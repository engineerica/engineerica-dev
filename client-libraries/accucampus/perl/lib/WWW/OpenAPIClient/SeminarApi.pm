...
#
package WWW::OpenAPIClient::SeminarApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'seminar_delete' } = { 
...
sub seminar_delete {
    ...
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling seminar_delete");
    }

    # parse inputs
    my $_resource_path = '/seminar/{id}';
...
# @param string $id The id of the seminar to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'seminar_get' } = { 
...
sub seminar_get {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling seminar_get");
    }
...
# @param string $termid Id of the term to list the events. Null to list all events. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'seminar_list' } = { 
...
sub seminar_list {
    ...
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling seminar_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling seminar_list");
    }

    # parse inputs
    my $_resource_path = '/seminar/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'seminar_save' } = { 
...
sub seminar_save {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling seminar_save");
    }
