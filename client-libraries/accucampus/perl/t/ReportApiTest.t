...
#
# report_attanalyticsprepare test
#
{
    ...
    my $result = $api->report_attanalyticsprepare(reportname => $reportname, params => $params, refreshgroup => $refreshgroup);
}
...
#
{
    ...
    my $params = undef; # replace NULL with a proper value
    my $result = $api->report_tagresults(reportname => $reportname, assign => $assign, tags => $tags, params => $params);
}
