...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ILicenseApi
    {
        ...
        /// <summary>
        /// Contact Engineerica in order to renew the AccuClub subscription Allows the user to select the option to contact Engineerica when the AccuClub account is nearing its renewal date.
        /// </summary>
