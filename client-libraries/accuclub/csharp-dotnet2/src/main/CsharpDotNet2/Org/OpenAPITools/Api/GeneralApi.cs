...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IGeneralApi
    {
        ...
        /// <summary>
        /// Export AccuClub data Allows the user to export data from AccuClub into a CSV, HTML, or Excel format.
        /// </summary>
        ...
        /// <summary>
        /// Import data into AccuClub Allows the user to import data into AccuClub via CSV or flat files either manually or automatically using the import utility.
        /// </summary>
