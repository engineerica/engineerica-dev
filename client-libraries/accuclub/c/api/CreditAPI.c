...
CreditAPI_creditDelete(apiClient_t *apiClient, char * id ,  body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/{id}");
...
CreditAPI_creditDiscountmethods(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/discountmethods")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/discountmethods");
...
CreditAPI_creditGetuserbalance(apiClient_t *apiClient, char * user )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/getuserbalance")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/getuserbalance");
...
CreditAPI_creditList(apiClient_t *apiClient, char * user , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/list")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/list");
...
CreditAPI_creditListdetails(apiClient_t *apiClient, char * credit , int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/listdetails")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/listdetails");
...
CreditAPI_creditListmine(apiClient_t *apiClient, int from , int count )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/listmine")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/listmine");
...
CreditAPI_creditSavedetails(apiClient_t *apiClient, UNKNOWN_BASE_TYPE_t * UNKNOWN_BASE_TYPE )
{
    ...
    // create the path
    long sizeOfPath = strlen("/credit/savedetails")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/credit/savedetails");
