...
import CreditplanApi from './api/CreditplanApi';
...
* <pre>
* var AccuClubOpenApi3 = require('index'); // See note below*.
* var xxxSvc = new AccuClubOpenApi3.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AccuClubOpenApi3.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AccuClubOpenApi3.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AccuClubOpenApi3.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    */
    ...
    /**
    * The CreditplanApi service constructor.
    * @property {module:api/CreditplanApi}
    */
    CreditplanApi,
