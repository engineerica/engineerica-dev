...
$apiInstance = new OpenAPI\Client\Api\MyApi(
...
try {
    ...
    echo 'Exception when calling MyApi->myAccount: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MyApi->myIanatimezone: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MyApi->myProfile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MyApi->myRights: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MyApi->mySaveprofile: ', $e->getMessage(), PHP_EOL;
}
?>
```
