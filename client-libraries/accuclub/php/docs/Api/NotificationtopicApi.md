# OpenAPI\Client\NotificationtopicApi
...
$apiInstance = new OpenAPI\Client\Api\NotificationtopicApi(
...
try {
    ...
    echo 'Exception when calling NotificationtopicApi->notificationtopicDelete: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NotificationtopicApi->notificationtopicGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NotificationtopicApi->notificationtopicList: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NotificationtopicApi->notificationtopicListsubscribe: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NotificationtopicApi->notificationtopicSave: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| The id of the topic to save (leave empty to create a new one). |
