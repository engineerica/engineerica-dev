...
class QrloginApi
{
     ...
     * @return void
     */
    public function qrloginGet()
    {
        $this->qrloginGetWithHttpInfo();
    }
     ...
     */
    public function qrloginGetWithHttpInfo()
    {
        $request = $this->qrloginGetRequest();
     ...
     */
    public function qrloginGetAsync()
    {
        return $this->qrloginGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qrloginGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->qrloginGetRequest();
     ...
     */
    protected function qrloginGetRequest()
    {

        $resourcePath = '/qrlogin/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
