...
#
package WWW::OpenAPIClient::CreditplanApi;
...
# @param AnyType $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'creditplan_delete' } = { 
...
# @return void
#
sub creditplan_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling creditplan_delete");
    }

    # parse inputs
    my $_resource_path = '/creditplan/{id}';
...
# @param string $id The id of the credit plan to get. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'creditplan_get' } = { 
...
sub creditplan_get {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling creditplan_get");
    }
...
# @param int $count The max number of records to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'creditplan_list' } = { 
...
sub creditplan_list {
    ...
    unless (exists $args{'from'}) {
      croak("Missing the required parameter 'from' when calling creditplan_list");
    }

    # verify the required parameter 'count' is set
    unless (exists $args{'count'}) {
      croak("Missing the required parameter 'count' when calling creditplan_list");
    }

    # parse inputs
    my $_resource_path = '/creditplan/list';
...
# @param UNKNOWN_BASE_TYPE $unknown_base_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'creditplan_save' } = { 
...
sub creditplan_save {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling creditplan_save");
    }
