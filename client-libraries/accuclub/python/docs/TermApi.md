...
body = None # object |  (optional)
    ...
    try:
        # Delete a term
        api_instance.term_delete(id, body=body)
    except ApiException as e:
        print("Exception when calling TermApi->term_delete: %s\n" % e)
```
...
# **term_list**
> term_list(_from=_from, count=count, notpast=notpast)
...
notpast = True # bool | Specifies whether the terms in the past should be returned or not. (optional)
    ...
    try:
        # Search and view details of all terms
        api_instance.term_list(_from=_from, count=count, notpast=notpast)
    except ApiException as e:
        print("Exception when calling TermApi->term_list: %s\n" % e)
```
...
# **term_save**
> term_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.TermApi(api_client)
    id = 'id_example' # str | The id of the term to save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create and edit terms
        api_instance.term_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling TermApi->term_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the term to save (leave empty to create a new one). | 
