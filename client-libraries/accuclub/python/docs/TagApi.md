...
body = None # object |  (optional)
    ...
    try:
        # Delete a tag
        api_instance.tag_delete(id, body=body)
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # View a list of tags
        api_instance.tag_list(group, _from, count)
    except ApiException as e:
        print("Exception when calling TagApi->tag_list: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TagApi->tag_listgroups: %s\n" % e)
```
...
# **tag_save**
> tag_save(id, unknown_base_type=unknown_base_type)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.TagApi(api_client)
    id = 'id_example' # str | The id of the tag save (leave empty to create a new one).
unknown_base_type = openapi_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)

    try:
        # Create or edit a tag
        api_instance.tag_save(id, unknown_base_type=unknown_base_type)
    except ApiException as e:
        print("Exception when calling TagApi->tag_save: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| The id of the tag save (leave empty to create a new one). | 
...
# **tag_search**
> tag_search(query, allowcreatingnew=allowcreatingnew)
...
allowcreatingnew = True # bool | Specifies whether an option to create a new tag should be retrieved. (optional)
    ...
    try:
        # Search for tags in the account
        api_instance.tag_search(query, allowcreatingnew=allowcreatingnew)
    except ApiException as e:
        print("Exception when calling TagApi->tag_search: %s\n" % e)
```
