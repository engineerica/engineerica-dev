...
id = 'id_example' # str | The id of the credit plan to get.
    ...
    try:
        ...
        print("Exception when calling DefaultApi->creditplanget: %s\n" % e)
```
...
# **creditplanlist**
> creditplanlist(token, _from, count)
...
count = 56 # int | The max number of records to return.
    ...
    try:
        # Gets the credit plans available
        api_instance.creditplanlist(token, _from, count)
    except ApiException as e:
        print("Exception when calling DefaultApi->creditplanlist: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->creditplansave: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->creditsave: %s\n" % e)
```
...
with openapi_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->creditsavedetails: %s\n" % e)
```
