...
class ActionlogApi(object):
    ...
    def actionlog_list(self, _from, count, **kwargs):  # noqa: E501
        ...
        >>> thread = api.actionlog_list(_from, count, async_req=True)
        >>> result = thread.get()
        ...
        return self.actionlog_list_with_http_info(_from, count, **kwargs)  # noqa: E501

    def actionlog_list_with_http_info(self, _from, count, **kwargs):  # noqa: E501
        """View a list of users action logs  # noqa: E501

        Allows the user to view the audit logs for the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.actionlog_list_with_http_info(_from, count, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('_from' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `_from` when calling `actionlog_list`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('count' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `count` when calling `actionlog_list`")  # noqa: E501
