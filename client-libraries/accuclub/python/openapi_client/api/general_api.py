...
class GeneralApi(object):
    ...
    def call_import(self, importtype, upload, **kwargs):  # noqa: E501
        """Import data into AccuClub  # noqa: E501

        Allows the user to import data into AccuClub via CSV or flat files either manually or automatically using the import utility.  # noqa: E501
    ...
    def export(self, exporttype, exportformat, **kwargs):  # noqa: E501
        """Export AccuClub data  # noqa: E501

        Allows the user to export data from AccuClub into a CSV, HTML, or Excel format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
