...
export declare const media: {
    lessThan(breakpoint: any, print?: boolean | undefined): (...args: any[]) => styledComponents.FlattenInterpolation<styledComponents.ThemedStyledProps<object, ResolvedThemeInterface>>;
