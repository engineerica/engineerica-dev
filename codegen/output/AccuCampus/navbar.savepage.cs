...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Navbar
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "navbar.savepage", new {@title, @link, @sortorder
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "navbar.savepage", new {@title, @link, @sortorder, @id, @roleids
});
		}
