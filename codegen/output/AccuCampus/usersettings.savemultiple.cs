...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.savemultiple", new {@optionsjson
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.savemultiple", new {@optionsjson, @user
});
		}
