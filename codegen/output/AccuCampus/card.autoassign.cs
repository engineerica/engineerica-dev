...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Card
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "card.autoassign", new {@conference
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "card.autoassign", new {@conference, @assignedto
});
		}
