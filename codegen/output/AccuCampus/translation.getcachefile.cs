...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Translation
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "translation.getcachefile", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "translation.getcachefile", new {@account
});
		}
