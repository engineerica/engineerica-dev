...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "event.save", new {@name, @code, @id, @codegroup, @term, @department, @details, @type, @recurringschedule, @onetimeschedule
});
		}
