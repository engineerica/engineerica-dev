...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "event.save", new {@name, @code
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "event.save", new {@name, @code, @id, @term, @department, @details, @recurringschedule, @onetimeschedule
});
		}
