...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Export
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "export", new {@exporttype, @exportformat
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "export", new {@exporttype, @exportformat, @filters
});
		}
