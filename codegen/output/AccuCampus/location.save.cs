...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Location
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "location.save", new {@name, @mapinfo
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "location.save", new {@name, @mapinfo, @id
});
		}
