...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "user.loadphoto", new {@upload
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "user.loadphoto", new {@upload, @filename, @userid, @automatch
});
		}
