...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "user.save", new {@firstname, @lastname, @email, @id, @middlename, @phonenumber, @streetaddress, @city, @state, @zipcode, @title, @company, @password, @roles, @assigncard, @cardnumber, @more, @photoid
});
		}
