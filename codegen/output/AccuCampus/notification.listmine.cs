...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Notification
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "notification.listmine", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "notification.listmine", new {@from, @count, @status, @startdate, @enddate
});
		}
