...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.get", new {@keys
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.get", new {@keys, @user
});
		}
