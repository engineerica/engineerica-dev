...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Bgjob
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "bgjob.getstatus", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "bgjob.getstatus", new {@jobid, @jobtype
});
		}
