...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class License
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "license.renew", new {@email, @phonenumber
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "license.renew", new {@email, @phonenumber, @jobtitle, @institution, @comments
});
		}
