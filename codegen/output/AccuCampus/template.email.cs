...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.email", new {@jobid, @emailsubject, @emailbody
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.email", new {@jobid, @emailsubject, @emailbody, @templatekind, @emailfrom, @emailreplyto
});
		}
