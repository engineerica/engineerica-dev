...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Station
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, false, "station.getinfo", new {@id
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, false, "station.getinfo", new {@id, @event
});
		}
