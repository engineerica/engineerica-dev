...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "attendancelog.fix", new {@status
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "attendancelog.fix", new {@status, @removebefore, @removeafter, @createstart, @createend, @changestartswipes, @changeendswipes, @event
});
		}
