...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Rule
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "rule.save", new {@name, @onevent, @conditionsjson, @actionsjson, @active
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "rule.save", new {@name, @onevent, @conditionsjson, @actionsjson, @active, @id, @description
});
		}
