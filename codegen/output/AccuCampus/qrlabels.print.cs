...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Qrlabels
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "qrlabels.print", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "qrlabels.print", new {@user, @group
});
		}
