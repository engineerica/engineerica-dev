...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Advrole
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "advrole.save", new {@name, @description, @policies, @editroles
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "advrole.save", new {@name, @description, @policies, @editroles, @id, @viewroles
});
		}
