...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Station
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "station.save", new {@name, @mode, @passcode, @id, @title, @instructions, @location, @shownames, @showphotos, @allowcreatingvisitors
});
		}
