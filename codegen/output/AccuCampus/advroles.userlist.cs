...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Advroles
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "advroles.userlist", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "advroles.userlist", new {@from, @count, @roleid, @onlywithoutcard, @photosize
});
		}
