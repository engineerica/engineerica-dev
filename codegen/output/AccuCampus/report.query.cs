...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Report
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "report.query", new {@reportname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "report.query", new {@reportname, @params
});
		}
