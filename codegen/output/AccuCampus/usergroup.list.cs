...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usergroup
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usergroup.list", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usergroup.list", new {@from, @count, @type
});
		}
