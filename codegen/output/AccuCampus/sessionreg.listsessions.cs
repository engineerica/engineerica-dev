...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Sessionreg
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "sessionreg.listsessions", new {@eventid
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "sessionreg.listsessions", new {@eventid, @sessiondate
});
		}
