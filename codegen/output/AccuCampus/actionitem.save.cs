...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Actionitem
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "actionitem.save", new {@type, @code, @name, @durationbasis, @duration
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "actionitem.save", new {@type, @code, @name, @durationbasis, @duration, @id, @description, @service, @eventbased, @followers, @notifyassignee
});
		}
