...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Service
	{
		...
		public static ActionResult Save(string @name, Guid @id, bool @globallyavailable
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "service.save", new {@name, @id, @globallyavailable
});
		}
