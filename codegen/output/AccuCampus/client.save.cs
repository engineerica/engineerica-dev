...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Client
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "client.save", new {@client, @clientname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "client.save", new {@client, @clientname, @pushtoken
});
		}
