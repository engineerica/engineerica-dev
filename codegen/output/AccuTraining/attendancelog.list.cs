...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.list", new {@from, @count, @filter
});
		}
