...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "event.getsessionsbydate", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "event.getsessionsbydate", new {@location, @date, @type
});
		}
