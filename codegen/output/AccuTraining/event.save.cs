...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "event.save", new {@name, @code
});
		}
		...
		public static ActionResult Save(string @name, string @code, Guid @id, string @term, string @department, string @details, string @recurringschedule, string @onetimeschedule
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "event.save", new {@name, @code, @id, @term, @department, @details, @recurringschedule, @onetimeschedule
});
		}
