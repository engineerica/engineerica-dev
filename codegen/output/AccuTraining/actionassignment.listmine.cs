...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actionassignment
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.listmine", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.listmine", new {@from, @count, @status
});
		}
