...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Sessionreg
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.savesettings", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.savesettings", new {@locationid, @eventid, @sessiondate, @enabled, @capacity, @trainerid
});
		}
