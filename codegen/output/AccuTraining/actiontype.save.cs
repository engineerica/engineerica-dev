...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actiontype
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actiontype.save", new {@name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actiontype.save", new {@name, @id, @description
});
		}
