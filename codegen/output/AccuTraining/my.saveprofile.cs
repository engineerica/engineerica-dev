...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class My
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "my.saveprofile", new {@firstname, @lastname, @email, @middlename, @phonenumber, @streetaddress, @city, @state, @zipcode, @title, @company
});
		}
