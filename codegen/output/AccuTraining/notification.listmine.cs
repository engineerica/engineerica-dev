...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Notification
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notification.listmine", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notification.listmine", new {@from, @count, @status, @startdate, @enddate
});
		}
