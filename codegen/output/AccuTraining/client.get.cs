...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Client
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "client.get", new {@client
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "client.get", new {@client, @clientname
});
		}
