...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Rule
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "rule.save", new {@name, @onevent, @conditionsjson, @actionsjson
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "rule.save", new {@name, @onevent, @conditionsjson, @actionsjson, @id, @description
});
		}
