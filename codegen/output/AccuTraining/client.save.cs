...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Client
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "client.save", new {@client, @clientname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "client.save", new {@client, @clientname, @pushtoken
});
		}
