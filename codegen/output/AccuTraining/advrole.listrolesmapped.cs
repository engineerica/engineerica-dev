...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Advrole
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advrole.listrolesmapped", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advrole.listrolesmapped", new {@map
});
		}
