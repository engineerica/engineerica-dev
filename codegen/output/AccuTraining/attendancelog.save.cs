...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.save", new {@id, @cardnumber, @user, @location, @event, @useeventschedule, @notes, @logdetails
});
		}
