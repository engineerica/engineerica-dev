...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Qrlabels
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "qrlabels.print", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "qrlabels.print", new {@user, @group
});
		}
