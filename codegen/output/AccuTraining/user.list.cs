...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "user.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "user.list", new {@from, @count, @roleid, @onlywithoutcard, @photosize
});
		}
