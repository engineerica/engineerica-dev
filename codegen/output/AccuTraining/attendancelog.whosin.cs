...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.whosin", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.whosin", new {@from, @count, @location, @event, @roles, @photosize, @extensions
});
		}
