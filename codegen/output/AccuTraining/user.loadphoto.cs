...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "user.loadphoto", new {@upload
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "user.loadphoto", new {@upload, @filename, @userid, @automatch
});
		}
