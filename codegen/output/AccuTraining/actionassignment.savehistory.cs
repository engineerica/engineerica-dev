...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actionassignment
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.savehistory", new {@actionassignment, @datedue, @completed
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.savehistory", new {@actionassignment, @datedue, @completed, @followers, @notifyassignee, @notes, @autocomplete
});
		}
