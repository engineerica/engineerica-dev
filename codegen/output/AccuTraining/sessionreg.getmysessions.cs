...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Sessionreg
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.getmysessions", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.getmysessions", new {@date
});
		}
