...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Sessionreg
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.listsessions", new {@eventid
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "sessionreg.listsessions", new {@eventid, @sessiondate
});
		}
