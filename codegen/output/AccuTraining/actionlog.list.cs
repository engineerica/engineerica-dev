...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actionlog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionlog.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionlog.list", new {@from, @count, @user, @startdate, @enddate, @resource, @actionfilter, @argument
});
		}
