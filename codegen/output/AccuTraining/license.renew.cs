...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class License
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "license.renew", new {@email, @phonenumber
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "license.renew", new {@email, @phonenumber, @jobtitle, @institution, @comments
});
		}
