...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Advroles
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advroles.userlist", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advroles.userlist", new {@from, @count, @roleid, @onlywithoutcard, @photosize
});
		}
