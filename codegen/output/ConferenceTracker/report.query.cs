...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class Report
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "report.query", new {@reportname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "report.query", new {@reportname, @params
});
		}
