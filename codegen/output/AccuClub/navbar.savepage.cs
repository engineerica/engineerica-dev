...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Navbar
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "navbar.savepage", new {@title, @link, @sortorder
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "navbar.savepage", new {@title, @link, @sortorder, @id, @roleids
});
		}
