...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Creditplan
	{
		...
		public static ActionResult Save(string @name, decimal @amount, decimal @paymentamount
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "creditplan.save", new {@name, @amount, @paymentamount
});
		}
		...
		public static ActionResult Save(string @name, decimal @amount, decimal @paymentamount, Guid @id, string @description, string @salesnotes, string @rulesjson, string @discountmethod, string @validfor
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "creditplan.save", new {@name, @amount, @paymentamount, @id, @description, @salesnotes, @rulesjson, @discountmethod, @validfor
});
		}
