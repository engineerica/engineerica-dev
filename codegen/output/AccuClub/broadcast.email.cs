...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Broadcast
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "broadcast.email", new {@sendto, @subject, @body
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "broadcast.email", new {@sendto, @subject, @body, @args, @from, @replyto
});
		}
