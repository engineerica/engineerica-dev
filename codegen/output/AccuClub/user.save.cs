...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "user.save", new {@firstname, @lastname, @email, @id, @middlename, @phonenumber, @streetaddress, @city, @state, @zipcode, @title, @company, @password, @roles, @assigncard, @cardnumber, @more, @photoid
});
		}
