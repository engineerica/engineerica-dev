...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "event.save", new {@name, @code, @id, @term, @department, @details, @recurringschedule, @onetimeschedule
});
		}
