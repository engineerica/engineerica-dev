...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Tag
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "tag.save", new {@group, @name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "tag.save", new {@group, @name, @id, @description, @requestedby, @viewroles, @editroles, @scopes
});
		}
