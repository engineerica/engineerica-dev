...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Card
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "card.autoassign", new {@conference
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "card.autoassign", new {@conference, @assignedto
});
		}
