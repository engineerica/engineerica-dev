...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Station
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, false, "station.getinfo", new {@id
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, false, "station.getinfo", new {@id, @event
});
		}
