...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "attendancelog.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "attendancelog.list", new {@from, @count, @filter
});
		}
