...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.email", new {@jobid, @emailsubject, @emailbody
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.email", new {@jobid, @emailsubject, @emailbody, @templatekind, @emailfrom, @emailreplyto
});
		}
