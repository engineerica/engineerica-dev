...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Report
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "report.prepare", new {@reportname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "report.prepare", new {@reportname, @params, @repformat, @fillgroupid, @groupby, @refreshgroup, @filtertext
});
		}
