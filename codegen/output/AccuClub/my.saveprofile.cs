...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class My
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "my.saveprofile", new {@firstname, @lastname, @email, @middlename, @phonenumber, @streetaddress, @city, @state, @zipcode, @title, @company
});
		}
