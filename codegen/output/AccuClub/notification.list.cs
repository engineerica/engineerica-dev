...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Notification
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notification.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notification.list", new {@from, @count, @recipient, @status, @startdate, @enddate, @sentonscreen, @sentemail, @sentsms
});
		}
