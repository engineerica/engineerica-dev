...
namespace EngineericaApi.AccuClass
{
	...
	public static partial class Usergroup
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "usergroup.save", new {@name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "usergroup.save", new {@name, @id, @description
});
		}
