...
namespace EngineericaApi.AccuWB
{
	...
	public static partial class Bgjob
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuWB, true, "bgjob.getstatus", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuWB, true, "bgjob.getstatus", new {@jobid, @jobtype
});
		}
