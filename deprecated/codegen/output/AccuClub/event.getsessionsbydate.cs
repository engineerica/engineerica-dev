...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "event.getsessionsbydate", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "event.getsessionsbydate", new {@location, @date, @type
});
		}
