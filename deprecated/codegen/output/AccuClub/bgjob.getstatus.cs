...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Bgjob
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "bgjob.getstatus", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "bgjob.getstatus", new {@jobid, @jobtype
});
		}
