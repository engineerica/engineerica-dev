...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Texttoimage
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "texttoimage", new {@text
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "texttoimage", new {@text, @fontcolor, @fontsize, @direction, @width
});
		}
