...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "usersettings.save", new {@key, @value
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "usersettings.save", new {@key, @value, @user
});
		}
