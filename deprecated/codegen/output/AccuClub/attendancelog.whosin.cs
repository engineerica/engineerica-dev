...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "attendancelog.whosin", new {@from, @count, @location, @event, @roles, @photosize, @extensions
});
		}
