...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Report
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "report.query", new {@reportname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "report.query", new {@reportname, @params
});
		}
