...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Swipe
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "swipe.save", new {@time, @cardnumber, @client
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "swipe.save", new {@time, @cardnumber, @client, @type, @location, @event, @clientname, @metadata, @photosize
});
		}
