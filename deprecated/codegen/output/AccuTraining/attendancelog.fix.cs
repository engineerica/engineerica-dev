...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.fix", new {@status
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "attendancelog.fix", new {@status, @removebefore, @removeafter, @createstart, @createend, @changestartswipes, @changeendswipes, @event
});
		}
