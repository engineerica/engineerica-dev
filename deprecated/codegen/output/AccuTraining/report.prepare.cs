...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Report
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "report.prepare", new {@reportname
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "report.prepare", new {@reportname, @params, @repformat, @fillgroupid, @groupby, @refreshgroup, @filtertext
});
		}
