...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class Bgjob
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "bgjob.getstatus", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "bgjob.getstatus", new {@jobid, @jobtype
});
		}
