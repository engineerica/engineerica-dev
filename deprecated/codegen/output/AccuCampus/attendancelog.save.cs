...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "attendancelog.save", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "attendancelog.save", new {@id, @cardnumber, @user, @location, @event, @useeventschedule, @notes, @logdetails
});
		}
