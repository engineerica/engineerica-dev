...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class Import
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "import", new {@importtype, @upload
});
		}
		...
		public static ActionResult Execute(ImportType @importtype, string @upload, string @filename
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "import", new {@importtype, @upload, @filename
});
		}
