...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class Card
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "card.autoassign", new {@conference
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "card.autoassign", new {@conference, @assignedto
});
		}
