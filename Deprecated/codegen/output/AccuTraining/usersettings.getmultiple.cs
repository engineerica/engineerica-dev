...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "usersettings.getmultiple", new {@keys
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "usersettings.getmultiple", new {@keys, @user
});
		}
