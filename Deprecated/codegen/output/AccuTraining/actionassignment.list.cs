...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actionassignment
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionassignment.list", new {@from, @count, @assignee, @status
});
		}
