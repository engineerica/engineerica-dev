...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Export
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "export", new {@exporttype, @exportformat
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "export", new {@exporttype, @exportformat, @filters
});
		}
