...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Notification
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notification.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notification.list", new {@from, @count, @recipient, @status, @startdate, @enddate, @sentonscreen, @sentemail, @sentsms
});
		}
