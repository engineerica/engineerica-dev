...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Event
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "event.save", new {@name, @code, @id, @codegroup, @term, @department, @details, @type, @recurringschedule, @onetimeschedule
});
		}
