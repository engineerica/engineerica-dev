...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Tag
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "tag.search", new {@query
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "tag.search", new {@query, @allowcreatingnew
});
		}
