...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Location
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "location.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "location.list", new {@from, @count, @locations, @sortbygroup
});
		}
