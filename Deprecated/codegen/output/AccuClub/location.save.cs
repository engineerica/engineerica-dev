...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Location
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "location.save", new {@name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "location.save", new {@name, @id, @categoryid, @categoryname, @streetaddress, @latitude, @longitude, @websiteurl, @email
});
		}
