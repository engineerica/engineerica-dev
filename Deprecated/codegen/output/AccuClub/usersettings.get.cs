...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "usersettings.get", new {@keys
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "usersettings.get", new {@keys, @user
});
		}
