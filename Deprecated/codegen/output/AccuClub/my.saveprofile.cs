...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class My
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "my.saveprofile", new {@firstname, @lastname, @email
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "my.saveprofile", new {@firstname, @lastname, @email, @middlename, @mobilephonenumber, @homephonenumber, @workphonenumber, @streetaddress, @city, @state, @zipcode, @title, @company, @photoid
});
		}
