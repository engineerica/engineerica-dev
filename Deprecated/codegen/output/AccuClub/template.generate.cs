...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.generate", new {@template, @source, @singlefile
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.generate", new {@template, @source, @singlefile, @userid, @forsending, @role, @filters
});
		}
