...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Broadcast
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "broadcast.email", new {@sendto, @subject, @body
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "broadcast.email", new {@sendto, @subject, @body, @args, @from, @replyto
});
		}
