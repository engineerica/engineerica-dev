...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.generate", new {@template, @source, @singlefile
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.generate", new {@template, @source, @singlefile, @userid, @forsending, @role, @filters
});
		}
