...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.save", new {@key, @value
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.save", new {@key, @value, @user
});
		}
