...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Tag
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "tag.save", new {@group, @name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "tag.save", new {@group, @name, @id, @description, @requestedby, @viewroles, @editroles, @scopes
});
		}
