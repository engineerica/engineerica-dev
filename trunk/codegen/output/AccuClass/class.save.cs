...
namespace EngineericaApi.AccuClass
{
	...
	public static partial class Class
	{
		...
		public static ActionResult Save(string @code, string @name, string @semester, Guid @id, string @department, string @schedule, string @instructors
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "class.save", new {@code, @name, @semester, @id, @department, @schedule, @instructors
});
		}
