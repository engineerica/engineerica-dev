...
namespace EngineericaApi.AccuClass
{
	...
	public static partial class User
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "user.loadphoto", new {@upload
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "user.loadphoto", new {@upload, @filename, @userid, @automatch
});
		}
