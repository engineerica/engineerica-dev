...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class My
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "my.saveprofile", new {@firstname, @lastname, @email, @middlename, @phonenumber, @streetaddress, @city, @state, @zipcode, @title, @company
});
		}
