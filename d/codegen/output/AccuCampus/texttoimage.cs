...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Texttoimage
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "texttoimage", new {@text
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "texttoimage", new {@text, @fontcolor, @fontsize, @direction, @width
});
		}
