...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Search
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "search", new {@query
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "search", new {@query, @page
});
		}
