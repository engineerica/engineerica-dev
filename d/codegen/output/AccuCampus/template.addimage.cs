...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.addimage", new {@template, @upload
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.addimage", new {@template, @upload, @filename
});
		}
