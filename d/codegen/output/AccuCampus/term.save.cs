...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Term
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "term.save", new {@name, @start, @end
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "term.save", new {@name, @start, @end, @id
});
		}
