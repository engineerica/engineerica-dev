...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usergroup
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usergroup.save", new {@name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usergroup.save", new {@name, @id, @description, @isprivate, @viewroles, @editroles, @scopes
});
		}
