...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Advrole
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advrole.list", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "advrole.list", new {@includepolicies, @includeinternal, @name
});
		}
