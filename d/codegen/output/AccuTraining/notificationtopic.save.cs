...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Notificationtopic
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notificationtopic.save", new {@name, @description
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "notificationtopic.save", new {@name, @description, @id, @enableonscreendelivery, @sendonscreendefault, @enableemaildelivery, @sendemaildefault, @enablesmsdelivery, @sendsmsdefault
});
		}
