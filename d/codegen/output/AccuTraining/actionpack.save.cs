...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Actionpack
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionpack.save", new {@code, @name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "actionpack.save", new {@code, @name, @id, @description, @items
});
		}
