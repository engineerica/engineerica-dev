...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Doc
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, false, "doc", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, false, "doc", new {@excludeanonymous
});
		}
