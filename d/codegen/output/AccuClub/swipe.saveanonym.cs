...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Swipe
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, false, "swipe.saveanonym", new {@station, @user
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, false, "swipe.saveanonym", new {@station, @user, @time, @event, @location, @type
});
		}
