...
namespace EngineericaApi.ConferenceTracker
{
	...
	public static partial class Attendancelog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "attendancelog.fix", new {@status
});
		}
		...
		/// <param name="@workshop">Apply to all att logs of this workshop.</param>


		public static ActionResult Fix(string @status, bool @removebefore, bool @removeafter, bool @createstart, bool @createend, bool @changestartswipes, bool @changeendswipes, Guid @workshop
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.ConferenceTracker, true, "attendancelog.fix", new {@status, @removebefore, @removeafter, @createstart, @createend, @changestartswipes, @changeendswipes, @workshop
});
		}
