...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Notification
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notification.markasunread", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notification.markasunread", new {@id, @status, @startdate, @enddate
});
		}
