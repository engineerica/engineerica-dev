...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Advrole
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "advrole.save", new {@name, @description, @policies, @editroles
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "advrole.save", new {@name, @description, @policies, @editroles, @id, @viewroles
});
		}
