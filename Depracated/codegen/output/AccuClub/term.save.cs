...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Term
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "term.save", new {@name, @start, @end
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "term.save", new {@name, @start, @end, @id
});
		}
