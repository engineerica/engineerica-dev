...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Notificationtopic
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notificationtopic.save", new {@name, @description
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "notificationtopic.save", new {@name, @description, @id, @enableonscreendelivery, @sendonscreendefault, @enableemaildelivery, @sendemaildefault, @enablesmsdelivery, @sendsmsdefault
});
		}
