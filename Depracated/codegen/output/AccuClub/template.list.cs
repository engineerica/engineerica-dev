...
namespace EngineericaApi.AccuClub
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.list", new {@from, @count, @kind
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClub, true, "template.list", new {@from, @count, @kind, @designedonly
});
		}
