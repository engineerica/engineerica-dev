...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.getmultiple", new {@keys
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "usersettings.getmultiple", new {@keys, @user
});
		}
