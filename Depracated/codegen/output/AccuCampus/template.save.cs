...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Template
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.save", new {@kind, @name
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "template.save", new {@kind, @name, @id, @description
});
		}
