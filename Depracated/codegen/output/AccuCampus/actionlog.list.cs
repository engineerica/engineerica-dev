...
namespace EngineericaApi.AccuCampus
{
	...
	public static partial class Actionlog
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "actionlog.list", new {@from, @count
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuCampus, true, "actionlog.list", new {@from, @count, @user, @startdate, @enddate, @resource, @actionfilter, @argument
});
		}
