...
namespace EngineericaApi.AccuClass
{
	...
	public static partial class Attendancelog
	{
		...
		public static ActionResult Listsummary(Guid @classid, Guid @studentid, Guid @groupid, string @start, string @end
)
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuClass, true, "attendancelog.listsummary", new {@classid, @studentid, @groupid, @start, @end
});
		}
