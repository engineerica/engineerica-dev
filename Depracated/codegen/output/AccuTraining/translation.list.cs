...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Translation
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "translation.list", new {
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "translation.list", new {@filter, @nondefaultonly, @appdefaultasuniversal
});
		}
