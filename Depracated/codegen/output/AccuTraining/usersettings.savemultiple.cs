...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Usersettings
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "usersettings.savemultiple", new {@optionsjson
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "usersettings.savemultiple", new {@optionsjson, @user
});
		}
