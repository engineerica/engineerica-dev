...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Usergroup
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "usergroup.save", new {@name, @id, @description, @isprivate, @viewroles, @editroles, @scopes
});
		}
