...
namespace EngineericaApi.AccuTraining
{
	...
	public static partial class Station
	{
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "station.save", new {@name, @mode, @passcode
});
		}
		...
		{
			return ActionExecutor.ExecuteInternal(ConnectionInformation.AccuTraining, true, "station.save", new {@name, @mode, @passcode, @id, @title, @instructions, @location, @shownames, @showphotos, @photopixelwidth, @allowcreatingvisitors
});
		}
